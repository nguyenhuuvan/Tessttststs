...
public class MathsActivity extends AppCompatActivity {
    ...
    public void next(View view) {
        phantuso += 1;
        if (phantuso + 1 > example.getQuiz().getMaths().size()) {
            Intent intent = new Intent(MathsActivity.this,KetquaActivity.class);
            ...
            tvCauhoi.setText(example.getQuiz().getMaths().get(phantuso).getQuestion());
            btnDapAn1.setText(example.getQuiz().getMaths().get(phantuso).getOptions().get(0));
            btnDapAn2.setText(example.getQuiz().getMaths().get(phantuso).getOptions().get(1));
            btnDapAn3.setText(example.getQuiz().getMaths().get(phantuso).getOptions().get(2));
            btnDapAn4.setText(example.getQuiz().getMaths().get(phantuso).getOptions().get(3));
        }
    ...
    public void dapan1(View view) {
        if (phantuso < example.getQuiz().getMaths().size()) {
            if (btnDapAn1.getText().toString().equalsIgnoreCase(example.getQuiz().getMaths().get(phantuso).getAnswer())) {
    ...
    public void dapan2(View view) {
        ...
        if (phantuso < example.getQuiz().getMaths().size()) {
            if (btnDapAn2.getText().toString().equalsIgnoreCase(example.getQuiz().getMaths().get(phantuso).getAnswer())) {
                Toast.makeText(this, "Đáp án đúng", Toast.LENGTH_SHORT).show();
                diemso += 1;
                Log.e("diemso: ", diemso + "");
            } else
    ...
    public void dapan3(View view) {
        ...
        if (phantuso < example.getQuiz().getMaths().size()) {
            if (btnDapAn3.getText().toString().equalsIgnoreCase(example.getQuiz().getMaths().get(phantuso).getAnswer())) {
                Toast.makeText(this, "Đáp án đúng", Toast.LENGTH_SHORT).show();
                diemso += 1;
                Log.e("diemso: ", diemso + "");
            } else
    ...
    public void dapan4(View view) {
        if (phantuso < example.getQuiz().getMaths().size()) {
            if (btnDapAn4.getText().toString().equalsIgnoreCase(example.getQuiz().getMaths().get(phantuso).getAnswer())) {
                Toast.makeText(this, "Đáp án đúng", Toast.LENGTH_SHORT).show();
                diemso += 1;
                Log.e("diemso: ", diemso + "");
            } else
